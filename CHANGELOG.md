...
- Внешний IFR-экстрактор удален из исходного дерева; HII/IFR теперь извлекается собственным нативным парсером.
...
- Нативный разбор BIOS firmware volume/FFS/sections без включенных исходников внешнего BIOS-экстрактора.
